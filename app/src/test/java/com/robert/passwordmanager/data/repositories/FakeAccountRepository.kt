...
class FakeAccountRepository(): AccountRepository {
    ...
    init {
        accounts.add(Account(websiteName = "Facebook", id = 1, userName = "johnie@yahoo.com", category = "Application", password = "gdjAgdkd@!AS142@hsAg",
            passwordStrength = 0.8, passwordStrengthLabel = "Very strong password", date = "12 may 2023"))
        accounts.add(Account(websiteName = "Dropbox", id = 2, userName = "mercy@yahoo.com", category = "Website", password = "gdj237Tads!AS142@hsAg",
    ...
    override fun observeAllAccounts(): LiveData<List<Account>>{
        observableAccounts.postValue(accounts)
    ...
    private suspend fun check(){
        ...
        insert(account)
        val list = observeAllAccounts().value
        println(list)
    }
